...
values('front-end','Front End','$2y$10$06xXY/0DPVGrWtLSV66V9.6LE0nEYJCW8bBUc3P1LB9Z9wC/ZRYYu', 'refresh_token,password', 'all', null, 3600, 72000, '','');

insert into `auth_client` (`client_id`,`client_name`,`client_secret`,`authorized_grant_types`,`scopes`,`resource_ids`,`access_token_validity`,`refresh_token_validity`,`additional_information`,`web_server_redirect_uri`)
values('user-service','Manage User','$2y$10$06xXY/0DPVGrWtLSV66V9.6LE0nEYJCW8bBUc3P1LB9Z9wC/ZRYYu', 'client_credentials', 'all', null, 3600, 72000, '','');
